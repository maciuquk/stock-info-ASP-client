...
namespace stockInfoASPClient.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} musi mieć conajmniej {2} i maksymalnie długość {1}", MinimumLength = 6)]
